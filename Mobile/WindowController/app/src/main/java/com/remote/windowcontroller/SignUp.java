    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signUp_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    AlertDialog.Builder pwdWarning = new AlertDialog.Builder(SignUp.this);
                    ...
                    {
                        AlertDialog.Builder nullWarning = new AlertDialog.Builder(SignUp.this);
                        ...
                        if (Error.equals("0")){
                            ...
                            AlertDialog.Builder fail = new AlertDialog.Builder(SignUp.this);
